...
export class DisciplineCard {
  /**
   * Converte string de ícone em SVG
   */
  private static getIconSvg(iconName: string, color: string): string {
    const iconMap: Record<string, string> = {
      ...
      brain: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44L2 22a2.5 2.5 0 0 1-2.5-2.5v-15A2.5 2.5 0 0 1 2 2h7.5z"></path><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44L22 22a2.5 2.5 0 0 0 2.5-2.5v-15A2.5 2.5 0 0 0 22 2h-7.5z"></path></svg>`,
      ...
      calculator: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="2" width="16" height="20" rx="2"></rect><line x1="8" y1="6" x2="16" y2="6"></line><line x1="8" y1="10" x2="16" y2="10"></line><line x1="8" y1="14" x2="16" y2="14"></line><line x1="8" y1="18" x2="16" y2="18"></line></svg>`,
      ...
      speedometer: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M12 2v10"></path><path d="M12 2a10 10 0 0 1 7.07 2.93"></path></svg>`,
    ...
    return iconMap[iconName] || `<div class="card-icon-placeholder" style="color: ${color};">${iconName}</div>`;
  }
  ...
  static render(discipline: Discipline, id: string): string {
    ...
    if (discipline.icon && discipline.icon.startsWith('<svg')) {
      // SVG completo - aplicar cor
      iconHtml = discipline.icon.replace(/<svg/g, `<svg style="stroke: ${discipline.color};"`);
    } else if (discipline.icon) {
      // String de ícone - converter para SVG
      iconHtml = this.getIconSvg(discipline.icon, discipline.color);
    } else {
      // Fallback - usar código
      iconHtml = `<div class="card-icon-placeholder" style="color: ${discipline.color};">${discipline.code}</div>`;
    }
